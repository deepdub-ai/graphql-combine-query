...
export interface NewCombinedQueryBuilder {
    ...
    addAssorted: <TVariables = OperationVariables>(document: DocumentNode[], variables: TVariables[], variableRenameFn?: RenameFnWithIndex, fieldRenameFn?: RenameFnWithIndex) => CombinedQueryBuilder<{}, {}>;
}
export interface CombinedQueryBuilder<TData = any, TVariables extends OperationVariables = {}> {
    ...
    addAssorted: <TVariablesAdd = OperationVariables>(document: DocumentNode[], variables: TVariablesAdd[], variableRenameFn?: RenameFnWithIndex, fieldRenameFn?: RenameFnWithIndex) => CombinedQueryBuilder<TData, TVariables>;
}
